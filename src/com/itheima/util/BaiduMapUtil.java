...
public class BaiduMapUtil {
    ...
    public static void drawAnotherPointByGeo(Context context,BaiduMap baiduMap,LatLng latLng,String shopName){
        ...
        markOverlay[1] = drawMarker(baiduMap,latLng,BitmapDescriptorFactory.fromResource(R.drawable.shop),markZIndex);
    ...
    public static class MyListener implements BDLocationListener {
        ...
        public MyListener(Context context, BaiduMap baiduMap, TextView tv_distance, LatLng latLng,String mOhterTitle){
            initData();
        ...
        public void onReceiveLocation(BDLocation result) {
            if (result != null) {
                ...
                if(markOverlay[0]!=null){
                    ...
                    markOverlay[0] = drawMarker(this.baiduMap,latLng,BitmapDescriptorFactory.fromResource(R.drawable.here),markZIndex);
